...
2. Run CMake and Compile the plugin in `Release` modd
...
4. Open the generated `installer_script_windows_full.iss` script file in the `Packaging` folder using `Inno Setup Compiler`
